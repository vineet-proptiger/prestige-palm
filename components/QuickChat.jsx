        ...
        <div className="bg-[#e7e1d5] rounded-2xl overflow-hidden shadow-lg border border-black/5">
          ...
          <div className="bg-[#005B4F] text-white px-4 py-3 flex items-center">
            ...
            <div className="ml-3 flex flex-col">
              <strong className="text-[15px] font-semibold leading-tight">Prestige Palm Court</strong>
          ...
          <div className="p-5 flex flex-col gap-4">
            <div className="bg-white text-[#151515] text-[14px] px-4 py-3 rounded-2xl rounded-tl-sm w-fit shadow-sm max-w-[85%] self-start">
              Hi 👋 What would you like to know about Prestige Palm Court?
            </div>
            ...
            <div className="flex flex-wrap justify-end gap-2.5">
              {[
                ...
                {text: "📄 Send brochure (PDF)", link: "https://wa.me/919718344024?text=Hi%2C%20please%20share%20the%20Prestige%20Palm%20Court%20brochure%20and%20official%20PDF."},
                {text: "📞 Request a callback", link: "https://wa.me/919718344024?text=Hi%2C%20please%20schedule%20a%20callback%20for%20Prestige%20Palm%20Court.%20My%20preferred%20time%20is%3A"}
              ].map((pill, i) => (
